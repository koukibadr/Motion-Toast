...
class MotionToast extends StatefulWidget {
  ...
  MotionToast({
    ...
    this.enableAnimation = defaultEnableAnimationValue,
    this.layoutOrientation = defaultLayoutOrientation,
    this.animationType = defaultAnimationValue,
    this.animationDuration = defaultAnimationDuration,
    this.toastDuration = defaultToastDuration,
    this.animationCurve = defaultCurveValue,
    this.position = defaultPositionValue,
    this.borderRadius = defaultRadius,
    this.onClose,
    this.dismissable = defaultDismissableValue,
    this.secondaryColor,
    this.backgroundType = defaultBackgroundTypeValue,
  }) : super(key: key) {
    _assertValidValues();
